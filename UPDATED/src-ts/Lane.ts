//A lane object rides on top of a Road object and actually stores cars and their data
//Not used in AStar pathfinder
/**
 ...
 */
function laneFactory(entrance: Light, exit: Light, parentRoad: Road): Lane {
